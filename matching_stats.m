...
%    
%    path = sprintf('/media/wollex/Data/Documents/Uni/2016-XXXX_PhD/Japan/Work/Data/839/match_stats_%d.jpg',nSes);
%    saveas(fig,path,'jpg')
%      
%    disp(sprintf('saved under %s',path))
  ...
  fig = figure;
  hold on
  histogram(nMatches(nMatches<3),linspace(1,nSes,nSes),'FaceColor','y')
  histogram(nMatches(nMatches>=3),linspace(1,nSes,nSes),'FaceColor','b')
